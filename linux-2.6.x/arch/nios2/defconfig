...
#
CONFIG_SERIAL_AVALON_JTAGUART=y
CONFIG_SERIAL_AVALON_JTAGUART_CONSOLE=y
# CONFIG_SERIAL_AVALON_JTAGUART_CONSOLE_BYPASS is not set
CONFIG_SERIAL_AVALON_UART=y
CONFIG_SERIAL_AVALON_UART_MAXPORTS=4
CONFIG_SERIAL_AVALON_UART_BAUDRATE=115200
# CONFIG_SERIAL_AVALON_UART_CONSOLE is not set
