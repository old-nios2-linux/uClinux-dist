 ...
 * hdr = genlmsg_put(msg, PID, SEQ, family, sizeof(hdr), NLM_F_ECHO,
 *                   MYOP, VERSION);
 *
...
/**
 * Create and connect generic netlink socket.
 * @arg handle		Netlink handle.
 *
 * Creates a NETLINK_GENERIC netlink socket, binds the socket and
