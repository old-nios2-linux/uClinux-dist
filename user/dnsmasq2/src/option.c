...
static const struct {
  ...
  { "-l, --dhcp-leasefile=path", gettext_noop("Specify where to read DHCP leases from (defaults to %s)."), LEASEFILE },
#elif DO_DHCP
...
#ifdef DO_PRELOAD
  { "-_, --preload-file=path", gettext_noop("Specify path to file of hosts to preload from."), NULL },
#endif
  { NULL, NULL, NULL }
}; 
