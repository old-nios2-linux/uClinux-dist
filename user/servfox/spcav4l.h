...
void qualityUp(struct vdIn *vdin);
void qualityDown(struct vdIn *vdin);
void timeUp(struct vdIn *vdin);
void timeDown(struct vdIn *vdin);
void spcaSetAutoExpo(struct vdIn *vdin);
#endif /* SPCAV4L_H */
