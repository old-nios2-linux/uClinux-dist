...
# CONFIG_USER_BUSYBOX_FEATURE_EDITING_SAVEHISTORY=y is not set
...
# # CONFIG_USER_BUSYBOX_REV=y is not set is not set
...
# CONFIG_USER_BUSYBOX_FLOCK=y is not set
...
# CONFIG_USER_BUSYBOX_HUSH_SAVEHISTORY=y is not set
