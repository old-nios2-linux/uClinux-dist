...
CONFIG_USER_BUSYBOX_FEATURE_NON_POSIX_CP=y
...
CONFIG_USER_BUSYBOX_FEATURE_HWIB=y
...
# Init Utilities
#
CONFIG_USER_BUSYBOX_BOOTCHARTD=y
CONFIG_USER_BUSYBOX_FEATURE_BOOTCHARTD_BLOATED_HEADER=y
CONFIG_USER_BUSYBOX_FEATURE_BOOTCHARTD_CONFIG_FILE=y
...
#
CONFIG_USER_BUSYBOX_BLOCKDEV=y
...
# CONFIG_USER_BUSYBOX_FEATURE_MDEV_LOAD_FIRMWARE is not set
...
CONFIG_USER_BUSYBOX_FEATURE_LAST_SMALL=y
# CONFIG_USER_BUSYBOX_FEATURE_LAST_FANCY is not set
...
#
CONFIG_USER_BUSYBOX_NBDCLIENT=y
...
CONFIG_USER_BUSYBOX_POWERTOP=y
...
# CONFIG_USER_BUSYBOX_HUSH_JOB is not set
# CONFIG_USER_BUSYBOX_HUSH_TICK is not set
# CONFIG_USER_BUSYBOX_HUSH_IF is not set
# CONFIG_USER_BUSYBOX_HUSH_LOOPS is not set
# CONFIG_USER_BUSYBOX_HUSH_CASE is not set
# CONFIG_USER_BUSYBOX_HUSH_FUNCTIONS is not set
# CONFIG_USER_BUSYBOX_HUSH_RANDOM_SUPPORT is not set
# CONFIG_USER_BUSYBOX_HUSH_EXPORT_N is not set
...
# CONFIG_USER_BLACKFIN_V4L2_VIDEOTEST is not set
...
# CONFIG_GPTIMER_TEST is not set
