...
# CONFIG_LIB_ALSA_LIB is not set
...
# CONFIG_LIB_DIRECTFB is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_ASSUME_UNICODE is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_TAB_COMPLETION is not set
# CONFIG_USER_BUSYBOX_FEATURE_EDITING_FANCY_PROMPT is not set
# CONFIG_USER_BUSYBOX_FEATURE_EDITING_ASK_TERMINAL is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_CALL_TELINIT is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_UTMP is not set
# CONFIG_USER_BUSYBOX_FEATURE_WTMP is not set
CONFIG_USER_BUSYBOX_LOGIN=y
# CONFIG_USER_BUSYBOX_PAM is not set
# CONFIG_USER_BUSYBOX_LOGIN_SCRIPTS is not set
CONFIG_USER_BUSYBOX_FEATURE_NOLOGIN=y
CONFIG_USER_BUSYBOX_FEATURE_SECURETTY=y
...
# CONFIG_USER_BUSYBOX_FEATURE_MODUTILS_ALIAS is not set
# CONFIG_USER_BUSYBOX_FEATURE_MODUTILS_SYMBOLS is not set
...
CONFIG_USER_BUSYBOX_HTTPD=y
# CONFIG_USER_BUSYBOX_FEATURE_HTTPD_RANGES is not set
# CONFIG_USER_BUSYBOX_FEATURE_HTTPD_USE_SENDFILE is not set
# CONFIG_USER_BUSYBOX_FEATURE_HTTPD_SETUID is not set
CONFIG_USER_BUSYBOX_FEATURE_HTTPD_BASIC_AUTH=y
# CONFIG_USER_BUSYBOX_FEATURE_HTTPD_AUTH_MD5 is not set
CONFIG_USER_BUSYBOX_FEATURE_HTTPD_CGI=y
# CONFIG_USER_BUSYBOX_FEATURE_HTTPD_CONFIG_WITH_SCRIPT_INTERPR is not set
# CONFIG_USER_BUSYBOX_FEATURE_HTTPD_SET_REMOTE_PORT_TO_ENV is not set
CONFIG_USER_BUSYBOX_FEATURE_HTTPD_ENCODE_URL_STR=y
# CONFIG_USER_BUSYBOX_FEATURE_HTTPD_ERROR_PAGES is not set
# CONFIG_USER_BUSYBOX_FEATURE_HTTPD_PROXY is not set
...
CONFIG_USER_BUSYBOX_FEATURE_TELNETD_STANDALONE=y
...
CONFIG_USER_BUSYBOX_FEATURE_UDHCPC_ARPING=y
# CONFIG_USER_BUSYBOX_FEATURE_UDHCP_PORT is not set
CONFIG_USER_BUSYBOX_UDHCP_DEBUG=0
# CONFIG_USER_BUSYBOX_FEATURE_UDHCP_RFC3397 is not set
CONFIG_USER_BUSYBOX_UDHCPC_DEFAULT_SCRIPT="/usr/share/udhcpc/default.script"
...
CONFIG_USER_BUSYBOX_BB_SYSCTL=y
...
CONFIG_USER_BUSYBOX_HUSH_HELP=y
...
# CONFIG_USER_BUSYBOX_HUSH_LOCAL is not set
...
# CONFIG_USER_INETUTILS_RSH is not set
# CONFIG_USER_INETUTILS_RCP is not set
# CONFIG_USER_INETUTILS_RSHD is not set
