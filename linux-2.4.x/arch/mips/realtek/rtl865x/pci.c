...
//					FIXME: RTL865XC support different 16bits mode.
				...
				{	  		
					...
					printk("BusTimeout Clear Register 0xb8003004=%x fun=%d\n",REG32(0xb8003004),dev_function);
					dev_function++;
					config_base += 256;			
					continue;
				}
