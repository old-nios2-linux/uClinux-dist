...
/*
 *  linux/arch/m68knommu/platform/5208/config.c
 *
...
void coldfire_timer_init(void (*handler)(int, void *, struct pt_regs *))
{
    ...
    tp = (volatile struct mcfpit *) (MCF_IPSBAR + MCFPIT_BASE1);
    request_irq(64+MCFINT_PIT1, handler, SA_INTERRUPT, "ColdFire Timer", tp);

    icrp = (volatile unsigned char *) (MCF_IPSBAR + MCFICM_INTC0 +
        MCFINTC_ICR0 + MCFINT_PIT1);
    *icrp = 0x05; /* PIT1 with level 5, priority 3 */
...
unsigned long coldfire_timer_offset(void)
{
    ...
    tp = (volatile struct mcfpit *) (MCF_IPSBAR + MCFPIT_BASE1);
    ipr = (volatile unsigned long *) (MCF_IPSBAR + MCFICM_INTC0 + MCFINTC_IPRL);
    ...
    if (((offset * 2) < (1000000 / HZ)) && (*ipr & (1 << (MCFINT_PIT1))))
        offset += 1000000 / HZ;
    return offset;  
}
...
{
    /* Everything is auto-vectored on the 5208 */
}
