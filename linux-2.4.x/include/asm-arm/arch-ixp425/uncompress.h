...
static __inline__ void arch_decomp_setup(void)
{
	...
	if ((mach_type != MACH_TYPE_ESS710) && (mach_type != MACH_TYPE_IVPN) &&
	    (mach_type != MACH_TYPE_SG560) && (mach_type != MACH_TYPE_SG565) &&
	    (mach_type != MACH_TYPE_SG580) && (mach_type != MACH_TYPE_SHIVA1100) &&
	    (mach_type != MACH_TYPE_SG590) && (mach_type != MACH_TYPE_SG720) &&
	    (mach_type != MACH_TYPE_SG8100))
		console_output++;
