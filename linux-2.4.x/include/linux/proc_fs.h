...
#if CONFIG_PROC_FS > 61440
#error Maximum number of inodes in procfs must be 61440 or less.  Change CONFIG_PROC_NDYNAMIC
#endif

#define PROC_NDYNAMIC      CONFIG_PROC_NDYNAMIC
